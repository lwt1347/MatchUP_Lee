...
<article>
  <nav class="MainText">
    <?php
    echo '<div id = "writeButton"><a href="/jobduo/write.php"><button type="button" class="btn btn-primary">글 쓰기</button></a></div>';
     ?>
<br>
...
//////////////////////////////////////////////
    ...
    if($pageNum >= $total_page){
            ...
            echo '<font size=2><a href="/jobduo/freenoticeboard.php?page='.$total_page.'&list='.$list.'">마지막</a></font>';
